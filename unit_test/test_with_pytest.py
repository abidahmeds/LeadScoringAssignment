...
def test_load_data_into_db():
    ...
    cnx.close()
    assert sorted(df.columns) == sorted(ref_df.columns), "Schema of loaded_data does not match schema of loaded_data_test_case"
...
def test_map_categorical_vars():
    ...
    cnx.close()
    assert sorted(df.columns) == sorted(ref_df.columns), "categorical_variables_mapped does not match categorical_variables_mapped_test_case"    
